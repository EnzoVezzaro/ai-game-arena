  ...
  return (
    <div className="relative w-full max-w-[560px] mx-auto">
      <div className="relative aspect-square rounded-2xl border border-[#2a2a4a] bg-[#16162a]/60 overflow-hidden">
        <div className="absolute inset-0" style={{ backgroundImage: 'linear-gradient(hsla(222,34%,16%,0.5) 1px, transparent 1px), linear-gradient(90deg, hsla(222,34%,16%,0.5) 1px, transparent 1px)', backgroundSize: '28px 28px' }} />
        <div className="absolute inset-0" style={{ background: `radial-gradient(40rem 40rem at 50% 50%, hsl(189 95% 52% / 0.08), transparent 60%)` }} />
        ...
        <div className="absolute top-2 left-2 font-mono text-[9px] text-gray-500 tracking-wider">GRID {n}×{n}</div>
        <div className="absolute top-2 right-2 font-mono text-[9px] text-primary tracking-wider">TURN {state.turn}</div>
      </div>
    </div>
  );
}