...
export function GameView({ renderState, accent, turn, replay, arenaSlug }: GameViewProps) {
  ...
  if (html) {
    return (
      <div className="relative w-full">
        <div
          className="relative w-full max-w-[760px] mx-auto rounded-2xl border border-border bg-background overflow-hidden game-html"
          // The arena/game is trusted system content it produced via getRenderState
