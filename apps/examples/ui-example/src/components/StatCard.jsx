...
export default function StatCard({ icon, label, value, sub, accent = "#38bdf8", className }) {
  return (
    <div className={cn("glass rounded-2xl p-4 relative overflow-hidden", className)}>
      ...
      <div className="mt-2 font-display text-2xl font-bold tracking-tight" style={{ color: accent }}>{value}</div>
